    ...
    <div className="projects-container" id="projects">
      ...
      <div className="projects-grid">
        ...
        <div className="project">
          ...
          <a href="#" target="_blank" rel="noreferrer"><h2>Master Thesis – Securing AI Model APIs in MLOps</h2></a>
          <p>
        ...
        <div className="project">
          ...
          <a href="#" target="_blank" rel="noreferrer"><h2>Knowledge Graphs in Analytical Architectures</h2></a>
          <p>
        ...
        <div className="project">
          ...
          <a href="#" target="_blank" rel="noreferrer"><h2>Reputation & Sentiment Analysis on News Data</h2></a>
          <p>
        ...
        <div className="project">
          ...
          <a href="#" target="_blank" rel="noreferrer"><h2>Web Scraping – Movie Rating Review System</h2></a>
          <p>
        ...
        <div className="project">
          ...
          <a href="#" target="_blank" rel="noreferrer"><h2>Parking Lot Management System</h2></a>
          <p>
        ...
        <div className="project">
          ...
          <a href="#" target="_blank" rel="noreferrer"><h2>Cricket Game Application</h2></a>
          <p>
